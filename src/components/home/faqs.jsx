...
//     return (
//       <div>
//         <section className="bg-[#EFEFEF] text-[#1B084C] py-5 px-7">
//           <img src="/images/line.png" className="w-full" />
...
//                     </div>
//                     <span className=" font-bold text-2xl text-[#6A1FFF]">
//                       {openIndex === index ? "−" : "+"}
//                     </span>
//                   </div>
//                   {openIndex === index && (
//                     <p className="text-[#6A1FFF] mt-3 font-museo">
//                       {faq.answer}
//                     </p>
//                   )}
//                 </div>
...
//             <h2 className="text-3xl md:text-4xl font-light text-white mb-4 font-museo">
//               Still Have <span className="font-bold">Questions?</span>
//             </h2>
//             <p className="text-white text-base md:text-lg max-w-2xl mx-auto mb-8">
//               Our recruitment experts are here to help. Get in touch for a
//               personalized consultation about your hiring needs.
//             </p>
//             <div className="flex flex-col sm:flex-row justify-center gap-4 font-museo">
//               <button className="bg-white text-[#1B084C] font-medium py-3 px-6 rounded-full shadow hover:bg-gray-100 transition">
//                 Contact experts
//               </button>
//               <button className="bg-white text-[#1B084C] font-medium py-3 px-6 rounded-full shadow hover:bg-gray-100 transition">
//                 Schedule call
